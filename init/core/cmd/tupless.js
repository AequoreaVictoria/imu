const { PAGES_PATH, ROOT } = require("../lib/constants");
...
module.exports = function handleTupless(args) {
  ...
  fs.readdirSync(`./${PAGES_PATH}`)
    ...
    .map((page) => {
      ...
      if (hasJs) {
        try {
          execSync(`node ./.imu/build/js.js ${mode} ${page}`, {
            stdio: "inherit",
          });
        } catch (e) {
      ...
      if (hasHtml) {
        try {
          execSync(`node ./.imu/build/html.js ${mode} ${page}`, {
            stdio: "inherit",
          });
        } catch (e) {
      ...
      if (hasCss) {
        try {
          execSync(`node ./.imu/build/css.js ${mode} ${page}`, {
            stdio: "inherit",
          });
        } catch (e) {
      ...
      try {
        execSync(`node ./.imu/build/bundle.js ${mode} ${page}`, {
          stdio: "inherit",
        });
      } catch (e) {
      ...
      if (hasCompress) {
        try {
          execSync(`node ./.imu/build/compress.js ${page}`, {
            stdio: "inherit",
          });
        } catch (e) {
